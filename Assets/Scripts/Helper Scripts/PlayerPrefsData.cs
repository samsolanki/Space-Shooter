...
{
    public string KEY_TOTAL_COINS = "TotalCoins";
    public string KEY_BESTSCORE = "BestScore";
    public string KEY_UNLOCK_PLAYER = "UnLockedPlayer";
    ...
    public string KEY_NO_AD = "NO_Ads";
}
